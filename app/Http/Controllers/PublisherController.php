...
{
    private $folder = 'admin.publishers';
    private $uri = 'publishers';
    private $title = 'Publishers';
    ...
    {
        $data = Publisher::select(['id', 'name', 'created_at']);
    ...
    {
        $data['title'] = $this->title;
        $data['form'] = $formBuilder->create('App\Forms\PublisherForm', [
            'method' => 'POST',
